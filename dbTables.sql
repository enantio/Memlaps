...
CREATE TABLE Note_Share(author CHAR(30),title CHAR(25),share_W_user CHAR(30), PRIMARY KEY(author,title,share_W_user),FOREIGN KEY (author) REFERENCES User_Info(username),FOREIGN KEY (share_W_user) REFERENCES User_Info(username),FOREIGN KEY (title) REFERENCES Notes(title));
